 ...
 function loadcss(){
   ...
   css.rel    = 'stylesheet';
   css.type   = 'text/css';
   css.href   = '<?=SET_URL_PRODUCTION?>/notify-gestor/notify-gestorlite.css?v=4';
   css.media = 'all';
 ...
 notifyLoop = setInterval(function(){
  ...
  if(typeof memberidGl == "undefined"){
    console.log('Notify Gestor Lite: memberidGl undefined');
    clearInterval(notifyLoop);
    return false;
  }

  var url = '<?=SET_URL_PRODUCTION?>/notify-gestor/get.php?member='+memberidGl;
...
function notify_gestor(cliente,produto,bussines,position,time){
  var html_notify = '<div class="notify-gestor-'+position+' notify-gestor-container" id="notify-gestor-lite-div" ><div class="notify-gestor-body"><div class="notify-col-4"><img src="<?=SET_URL_PRODUCTION?>/notify-gestor/icon-128x128.gif" alt=""></div><div class="notify-col-8"><div class="notify-gestor-title">';
