               ...
               <div class="col-md-12 margin">
                    ...
                    <div id="como_pagar"  class="row" >
                            ...
                            <div <?php if($user->af == 0 || $user->af == NULL){ ?> class="col-md-4" <?php }else{ ?>  class="col-md-12  text-center" <?php } ?> id="mercadopago_div" >
                                <button onclick="meio_pay('ted');" id="btn_mp_pay" class="btn btn-lg btn-outline-secondary" >Pagamento por Pix </button>
                            </div>
                        ...
                        <div class="col-md-6" >
                            ...
                            <hr>
                             <ul>
                                ...
                                <img src="<?=SET_URL_PRODUCTION?>/painel/img/qrcode-pix.png?v=2" alt="Pix" width="70%"  /><br />
