 window.onload = function(e){
    ...
    function edit_reply(type){
        ...
        dadosPost.info = info;
        dadosPost.id = $("#id_reply").val();;

        var dados = JSON.stringify(dadosPost);

         $.post('../control/control.chatbot.php',{edit_reply:true,dados:dados},function(data){
             ...
             try{
                 ...
                 if(obj.erro){
                     ...
                     setTimeout(function(){
                        $("#res_add").html('');
                        location.href="settings_chatbot";
                     },1000);
                 }
