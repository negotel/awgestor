              ...
              <td>
                ...
                <button onclick="modal_del_plano(<?= $plano->id; ?>);" title="<?= $idioma->excluir; ?>" type="button" class="btn-outline-danger btn btn-sm  "> <i class="fa fa-trash" ></i> </button>
                    ...
                    <?php if($plano_usergestor->link_pay){ ?>
                      <button onclick="modal_link_plano( <?php if(@$mp_credenciais->client_id != "" && @$mp_credenciais->client_secret != ""){ ?>'https://glite.me/p/<?= str_replace('=','',base64_encode($plano->id)); ?>'<?php } ?>);" title="Link de pagamento" type="button" class="btn-outline-primary btn btn-sm  "> <i class="fa fa-link" ></i> </button>
                    <?php } ?>
 ...
 <div class="modal-dialog" role="document">
   <div class="modal-content">
     ...
     <div class="modal-body" id="body_modal_del_plano" >
        ...
        <?php if(@$mp_credenciais->client_id != "" && @$mp_credenciais->client_secret != ""){ ?>

           <div class="col-md-12 margin">
               <p>
                   Requisitos para usar o link:
                   <ul>
                       <li>Ter adicionado as credencias do mercado pago em suas configurações</li>
                       <li>Estar com a área do cliente ativada</li>
                   </ul>
                   <br />
                   <span>Em breve terá mais opções de configuração do link. Está é a versão <b>beta</b></span>
               </p>
