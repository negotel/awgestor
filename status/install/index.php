                    ...
                    <section id="agreement" style="display: none">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p>Support is only done through direct <a href="https://altumcode.com/contact" target="_blank">email</a>. Please mention your proof of purchase when asking for support.</p>
                    ...
                    <section id="requirements" style="display: none">
                        ...
                        <table class="table mt-5">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>/uploads/status_pages_favicons/</td>
                                    <td><?= is_writable(ROOT . 'uploads/status_pages_favicons/') ? 'Writable' : 'Not Writable' ?></td>
                                    <td>
                                        <?php if(is_writable(ROOT . 'uploads/status_pages_favicons/')): ?>
                                            <img src="assets/svg/check-circle-solid.svg" class="img-fluid img-icon text-success" />
                                        <?php else: ?>
                                            <img src="assets/svg/times-circle-solid.svg" class="img-fluid img-icon text-danger" />
                                            <?php $requirements = false; ?>
                                ...
                                <tr>
                                    <td>/uploads/status_pages_logos/</td>
                                    <td><?= is_writable(ROOT . 'uploads/status_pages_logos/') ? 'Writable' : 'Not Writable' ?></td>
                                    <td>
                                        <?php if(is_writable(ROOT . 'uploads/status_pages_logos/')): ?>
                                            <img src="assets/svg/check-circle-solid.svg" class="img-fluid img-icon text-success" />
                                        <?php else: ?>
                                            <img src="assets/svg/times-circle-solid.svg" class="img-fluid img-icon text-danger" />
                                            <?php $requirements = false; ?>
