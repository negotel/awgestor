                ...
                <div class="col">
                    ...
                    <div id="description_container">
                        <div class="form-group">
                            ...
                            <div id="editor" style="height: 15rem;"></div>
...
<?php ob_start() ?>
<link href="<?= SITE_URL . ASSETS_URL_PATH . 'css/quill.snow.css?v=' . PRODUCT_CODE ?>" rel="stylesheet" media="screen,print">
<?php \Altum\Event::add_content(ob_get_clean(), 'head') ?>

<?php ob_start() ?>
<script src="<?= SITE_URL . ASSETS_URL_PATH . 'js/libraries/quill.min.js' ?>"></script>
