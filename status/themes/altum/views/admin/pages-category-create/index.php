                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input id="url" type="text" name="url" class="form-control form-control-lg <?= \Altum\Alerts::has_field_errors('url') ? 'is-invalid' : null ?>" placeholder="<?= language()->admin_pages_categories->input->url_placeholder ?>" value="" required="required" />
                    ...
                    <div class="form-group">
                        ...
                        <input id="title" type="text" name="title" class="form-control form-control-lg <?= \Altum\Alerts::has_field_errors('title') ? 'is-invalid' : null ?>" value="" required="required" />
            ...
            <div class="row mt-5">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <input id="description" type="text" name="description" class="form-control form-control-lg" value="" />
                    </div>

                    <div class="form-group">
                        <label for="icon"><?= language()->admin_pages_categories->input->icon ?></label>
                        <input id="icon" type="text" name="icon" class="form-control form-control-lg" placeholder="<?= language()->admin_pages_categories->input->icon_placeholder ?>" value="" />
                    ...
                    <div class="form-group">
                        ...
                        <input id="order" type="number" name="order" class="form-control form-control-lg" value="0" />
