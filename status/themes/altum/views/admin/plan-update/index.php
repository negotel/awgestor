    ...
    <div class="card-body">
        ...
        <form action="" method="post" role="form">
            ...
            <div class="row mt-4">
                ...
                <div class="col">
                    <button type="submit" name="submit" class="btn btn-primary mb-1"><?= language()->global->update ?></button>
                    <button type="submit" name="submit_update_users_plan_settings" class="btn btn-outline-primary mb-1"><?= language()->admin_plan_update->update_users_plan_settings->button ?></button>
                </div>
            </div>
        </form>
