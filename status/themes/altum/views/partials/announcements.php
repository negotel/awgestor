<?php if(
    ...
    <div id="announcements" class="w-100 py-3 bg-gray-100">
        <div class="container d-flex justify-content-center position-relative">
            <div><?= settings()->announcements->content ?></div>

            <div class="position-absolute ml-3" style="right: 0;">
                <button id="announcements_close" type="button" class="close" data-dismiss="alert"><i class="fa fa-fw fa-sm fa-times text-muted"></i></button>
            </div>
        </div>
    </div>
