    ...
    <div class="container">
        <div class="d-flex">
            <?php if($data->status_page->logo): ?>
                <img src="<?= SITE_URL . UPLOADS_URL_PATH . 'status_pages_logos/' . $data->status_page->logo ?>" class="img-fluid status-page-navbar-logo mr-3" alt="<?= $data->status_page->name ?>" loading="lazy" />
            <?php endif ?>
...
<div class="container mt-5 d-none d-lg-block">
    <div class="d-flex align-items-center position-relative">
        <?php if($data->status_page->logo): ?>
        <div>
            <img src="<?= SITE_URL . UPLOADS_URL_PATH . 'status_pages_logos/' . $data->status_page->logo ?>" class="img-fluid status-page-logo mr-4" alt="<?= $data->status_page->name ?>" loading="lazy" />
        </div>
        <?php endif ?>
