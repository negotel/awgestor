...
class WebhookStripe extends Controller {
    ...
    public function index() {
        ...
        $user = db()->where('user_id', $user_id)->getOne('users', ['user_id', 'email', 'payment_subscription_id', 'billing', 'referred_by', 'referred_by_has_converted']);
        ...
        if(settings()->email_notifications->new_payment && !empty(settings()->email_notifications->emails)) {
            ...
            send_mail(
                ...
                sprintf(language()->global->emails->admin_new_payment_notification->subject, 'stripe', $payment_total, $payment_currency),
