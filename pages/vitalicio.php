    ...
    <div class="hero-wrap js-fullheight">
      ...
      <div class="container-fluid px-0">
      	<div class="row d-md-flex no-gutters slider-text align-items-center js-fullheight justify-content-end">
            <img class="one-third align-self-end order-md-last img-fluid" src="<?=SET_URL_PRODUCTION?>/img/8888.png" alt="">
    		...
    		<div class="row justify-content-center mb-5">
              <div class="col-md-7 text-center heading-section heading-section-white ftco-animate">
                  <div class="col-md-12 text-center heading-section ftco-animate">
                    ...
                    <h2 id="valor_b2c" style="color:#6927ff;" >R$ <?= file_get_contents("<?=SET_URL_PRODUCTION?>/system/cont_user.php?mov_b2b");?></h2>
                    <p style="color:#000;" >
    	...
    	<div class="row justify-content-center mb-5 pb-3">
          ...
          <div class="row d-flex" style="width: 100%;">
              <div class="col-md-12" style="width: 100%;">
                  <iframe style="width: 100%!important;border: 0px;overflow-y: hidden;overflow-x: hidden;" class="iframe_compare" id="iframe-compare" src="<?=SET_URL_PRODUCTION?>/pages/compare.html?v=1" width="100%" height="700px" ></iframe>
              </div>
          </div>
        </div>
    	</div>
      ...
      <div class="container">
            ...
            <div class="ftco-footer-widget mb-4">
            	...
            	<div class="block-23 mb-3">
	              <ul>
	                ...
	                <li><a href="tel:08000000270"><span class="icon icon-phone"></span><span class="text">0800 000 0270</span></a></li>
        ...
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <p> Copyright &copy;<script>document.write(new Date().getFullYear());</script> Todos os direitos reservados | Uma ferramenta de <a href="https://scriptmundo.com" target="_blank">Script Mundo</a></p>
