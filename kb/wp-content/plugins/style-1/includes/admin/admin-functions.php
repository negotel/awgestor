...
function epkb_does_path_for_articles_need_update( $post_id, $post ) {
	...
	EPKB_Admin_Notices::add_ongoing_notice( __( 'We detected that your KB Main Page slug has changed. Please go to the Global Wizard to update slug for your articles for KB # ' . $kb_config['id'], 'echo-knowledge-base' ) .
