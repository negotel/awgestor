...
class EPKB_Templates_Various {
    ...
    public static function get_article_breadcrumb( $kb_config, $article_id ) {
        ...
        if ( $kb_config['show_articles_before_categories'] != 'off' ) {
            return self::get_article_breadcrumb_v1( $kb_config, $article_id );
        } else {
            return self::get_article_breadcrumb_v2( $kb_config, $article_id );
        }
    }
     ...
     * @return array
     */
    public static function get_article_breadcrumb_v1( $kb_config, $article_id ) {
     ...
     * @return array
     */
	public static function get_article_breadcrumb_v2( $kb_config, $article_id ) {
