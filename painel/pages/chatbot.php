                    ...
                    <div class="col-md-6">
                        <div class="btn-toolbar mb-2 mb-md-0">
                            <div class="btn-group mr-2">
                                <?php if ($getChatbot) { ?>
                                    <button onclick="$('#primeiros_passos_bot').modal('show');" type="button"
                                            class="btn btn-sm btn-outline-secondary"><i class="fa fa-fast-forward"></i>
                                        Passo-a-passo
                                    </button>
                                    <a target="_blank" href="https://youtu.be/b4ZWGyb-dfA"
                                       class="btn btn-sm btn-outline-secondary"><i class="fa fa-play"></i> Assistir
                                        Tutorial</a>
                                    <button onclick="location.href='settings_chatbot';" type="button"
                                            class="btn btn-sm btn-outline-secondary"><i class="fa fa-cog"></i>
                                        Configurar
                                    </button>
                                <?php } ?>
                            </div>
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="row list_contacts"
                                     style="overflow-y:scroll;max-height:500px;margin-top:25px;">

                                    <?php if ($getChatbot == false) { ?>
                                        <div class="col-md-12 text-center">
                                            <p class="text-center">
                                                <button class="btn btn-lg btn-primary"
                                                        onclick="location.href='settings_chatbot';">Primeiros passos
                                                </button>
                                            </p>
                                        </div>
                                    <?php } ?>
                                    ...
                                    if ($chats) {
                                        while ($chat = $chats->fetch(PDO::FETCH_OBJ)) {
                                            ...
                                            <!-- repeat -->
                                            <div onclick="organize_messages(<?= $chat->id; ?>,'<?= $name; ?>');"
                                                 class="card col-md-12"
                                                 style="cursor:pointer;padding-bottom:5px;padding-top:5px;">
                                                <input type="hidden" value='<?= base64_encode($chat->msgs); ?>'
                                                       id="json_<?= $chat->id; ?>"/>
                                                <div class="row">
                                                    <div class="col-md-4">
                                                        <div class="msg-img"
                                        ...
                                        <p class="text-center" style="margin-top:100px;font-size:10px;color:gray;">
                                            Ainda não há interações com o chatbot. Certifique-se que o mesmo está ativo
                                            em seu aplicativo. <br/>
                                            Verifique também se possui respostas para o bot. Basta clicar em <b> <i
                                                        class="fa fa-cog"></i> Configurar</b>
                                        </p>
                                ...
                                <section class="msger">
                                    ...
                                    <header class="msger-header">
                                        ...
                                        <div class="msger-header-options">
                                            <span onclick="remove_historic();"
                                                  style="cursor:pointer;color:#7922ff;font-size:20px;"><i
                                                        class="fa fa-leaf"></i></span>
                                            &nbsp;
                                            <span onclick="location.href='settings_chatbot';"
                                                  style="cursor:pointer;color:#7922ff;font-size:20px;"><i
                                    ...
                                    <main class="msger-chat">
                                        <center><img width="300"
                                                     src="<?= SET_URL_PRODUCTION ?>/img/robot_default.png"/>
                                        </center>
                                    </main>
...
<!--  Modal inicio -->
<div class="modal fade" id="primeiros_passos_bot" data-backdrop="static" tabindex="-1" role="dialog"
            ...
            <div class="modal-body" id="body_modal_inicio">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12" style="margin-left:10px;">
                        ...
                        <ol>
                            <li>
                                Baixe o Aplicativo <b>Auto Reply</b> <a target="_blank"
                                                                        href="https://play.google.com/store/apps/details?id=com.pransuinc.autoreply&hl=pt-pt">Clicando
                                    aqui</a>. <br/>
                                Ou o <b>Whats Auto</b> <a target="_blank"
                                                          href="https://play.google.com/store/apps/details?id=com.guibais.whatsauto&hl=pt-pt">Clicando
                                    aqui</a>.
                            ...
                            <br/>
                            <li>
                                Apague as mensagens padrão que estão no app e clique no ícone <i class="fa fa-plus"></i>
                                para adicionar uma nova resposta.
                            </li>
                            <br/>
                            <li>
                                Selecione qual whatsapp está usando para o bot, Wa Bussines para Whatsapp Bussines e
                                etc.
                            </li>
                            <br/>
                            <li>
                            ...
                            <br/>
                            <li>
                                No painel Gestor Lite, basta clicar em configurar para adicionar as respostas
                                automáticas.
                            </li>
                        </ol>
                ...
                <div class="modal-footer">
                    <a target="_blank" href="https://youtu.be/b4ZWGyb-dfA" id="btn_add_cvd" class="btn btn-info"> <i
                                class="fa fa-play"></i> Assistir um tutorial</a>
...
<script>
    ...
    function remove_historic() {
        if (window.confirm("Deseja remover todo histórico de mensagens?")) {
            $.post('../control/control.chatbot.php', {
                remove_istoric: true,
                chat: <?= @$getChatbot->id; ?>
            }, function (data) {
                location.href = "";
