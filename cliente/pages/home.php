        ...
        <div class="content-header row">
          <div class="content-header-left col-md-4 col-12 mb-2">
            ...
            $msg_boa_tarde = array(
              ...
              8 => "Quer conversar? <a href='{$link_gestor}/{$sp}/suporte' >Me chama aqui</a>",
          	...
          	<div class="col-12">
          		<div class="card">
          			...
          			<div class="card-content collapse show">
          				<div class="card-body">
          					<p class="card-text"> Se liga nas últimas faturas que você pagou :), ou também não pagou :(</p>
          					<?php 
