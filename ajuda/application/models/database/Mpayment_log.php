...
class Mpayment_log extends APP_Model{	
	...
	function SetValidation(){
		$this->validations=array(
			...
			"result"=>array("Text"=>"Result", "Rule"=>"required|max_length[1]"),
			"result_msg"=>array("Text"=>"Result Msg", "Rule"=>"required|max_length[150]"),
			...
			"pp_payer_email"=>array("Text"=>"Pp Payer Email", "Rule"=>"required|max_length[150]|valid_email"),
