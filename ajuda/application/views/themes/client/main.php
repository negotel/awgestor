		     ...
		     <div class="app-copywrite text-center">
				 <div class="<?php echo get_app_container_type();?> ">
				 	<div class="row main-footer-top">
						...
						<div class="col-md-12">
							<?php 
						 $defaultCData='&copy; Copyright <a href="http://www.appsbd.com">appsbd.com</a>'.date('Y');
						 $copywrite=Mapp_setting_api::GetSettingsValue("system", "site_copyw",$defaultCData);
                            ...
                            if($isHidePoweredBy){
                            ?>
                            <div class="powered-by"><?php _e("Powered By") ; ?> <a href="https://appsbd.com/bsspbl">Best Support System</a></div>
                            <?php    } ?>
						</div>
			        </div>
			     </div>
