...
?>
<section class="home-header" style="<?php if(!empty($img_bg_src)){ ?>background-image: url(<?php echo $img_bg_src; ?>);<?php } ?>">
    <?php
    ...
    <div class="<?php echo get_app_container_type();?>" style="color: <?php echo getThemeAPIValue_2020('_src_text_color',''); ?>;">
        ...
        <div id="header-src-box" class="header-src-box">
            <input type="text" id="app-src-input" class="src-input" placeholder="<?php echo getThemeAPIValue_2020('_src_placeholder','Ask You Question'); ?>" aria-label="" aria-describedby="">
            <span class="header-src-icon"> <i class="fa fa-search"></i></span>
            
            <div id="app-src-container" class="src-container text-left " style="display: none; z-index: 90;">
                <div class="" style="margin-top: -11px;position: absolute;left: 0;right: 0;top: 10px;">
