<div class="w-100">
	<div class="clearfix form p-3">
		...
		<?php
			...
			$input=input_box_2020::getInput("Input box placeholder","Ask You Question");
			get_inputbox_2020( $input->title, $name, getAPIPostValue_2020( $name ), $input->is_required, $input->placeholder );
        ...
        <div class="form-row">
            ...
            $input=input_box_2020::getInput("Text Color","Choose test Color");
            ...
            get_boolean_input_default_2020( $input->title, $name, getAPIPostValue_2020( $name ),"col-sm" ,'has_depend_fld');
        ...
        <div class="form-row">
			<?php
                ...
                $name='_src_bg_img';
                $input=input_box_2020::getImageInput("Background",$bgImageUrl,"Best size is 1900px X 900px",'width:371px; height:176px');
