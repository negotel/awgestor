			...
			<?php if(count($providers)>0){?>
				<div class="row"><div class="col-md-12  text-center">
					...
					foreach ($providers as $provider=>$link){?>
						<a href="<?php echo site_url($link.$redirect_token);?>" class="btn btn-sm btn-default btn-<?php echo strtolower($provider);?>"><i class="fab fa-<?php echo strtolower($provider);?>"></i> <?php echo $provider;?></a>
					<?php }?>					
				</div>
				</div>
				<?php }?>
