...
<body class="aps-ctrl-p skin-<?php echo !empty($_app_color)?$_app_color:"blue"; ?> sidebar-mini <?php  echo  !empty($_COOKIE['isSBC'])?' sidebar-collapse ':'';?>  <?php echo Mapp_setting::GetSettingsValue("is_rtl_admin")=="Y"?"app-rtl":""; ?> ">
<?php
...
?>	
    <div class="wrapper">      
        ...
        <section class="sidebar">
          ...
          <?php
            ...
            <li class="<?php echo $apm->isSelected?"active selected open ".(count($apm->submenus)>0?"has-sub":""):"";?> treeview">
              <a href="<?php echo !empty($apm->url)?$apm->url:'#'?>" class="<?php echo $apm->cssClass;?>">
      ...
      <footer class="main-footer">
        ...
        <strong><i class="ap ap-support-system" style="vertical-align: middle;"></i> <?php echo $_app_name;?>,  powered by , <a href="https://appsbd.com/product/best-support-system/">Best Support System</a>  </strong>.
      </footer>  
    </div><!-- ./wrapper -->
