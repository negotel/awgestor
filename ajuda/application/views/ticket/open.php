<div class="row">
		...
		<div class="panel panel-default app-panel-box">
		  ...
		  <div class="panel-body">		  
			 ...
			 <div class="form-group">
		      	...
		      	<div class="col-md-9">	      	                			     	
		      	<input type="text" maxlength="150" autocomplete="off"  value="<?php echo  $mainobj->GetPostValue("title");?>" class="form-control" id="title" name="title"      placeholder="<?php _e("Title"); ?>" data-bv-notempty="true" 	data-bv-notempty-message="<?php  _e("%s is required",__("Ticket subject"));?>">
		      	</div>
		      </div> 
		      <?php 
			...
			<div class="form-group">
		      	<label class="control-label label-required col-md-3" for="priroty"><?php _e("Priority"); ?></label>
	      		<div class="col-md-9">
		        ...
		        if(!empty($userdata) || $is_alpguest_ticket){
		            ...
		            $slostr="Low-".__("Please login to set priroty");
		        	GetHTMLOption("L", $slostr);
		        }
		            ?>
		      ...
		      <div class="form-group">
		      	...
		      	<div class="col-md-9">                   			     	
			        ...
			        <?php $category_selected= $mainobj->GetPostValue("cat_id");
			        	GetHTMLOption("", __("Select"),$category_selected);
		       ...
		       <?php 
			     ...
			     foreach ($custom_fields as $fld_group){
			      	foreach ($fld_group as $cfld){
			      	    ...
			      	    echo app_get_html_form_field($cfld,"custom_","custom-field-group ".$groups_ct."  grp-".$cfld->id);
			      	}			      
			      }
			    ?>
		      </div>
	...
	<div class="col-md-4 md-p-l-0">
		<?php echo $this->getModule("opent_ticket_right_module");?>		
	</div>
</div>
