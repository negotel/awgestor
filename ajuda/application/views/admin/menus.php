...
if($adminMenu){
	...
	//$adminMenu->AddSubMenu("AD","Theme Settings", "admin/admin-setting/theme","ap ap-theme");
	//$adminMenu->AddSubMenu("AD","Security Settings", "admin/admin-setting/security","ap ap-shield");
	//$adminMenu->AddSubMenu("AD","Notification Settings", "admin/admin-setting/notification","fa fa-bell");
	//$adminMenu->AddSubMenu("AD","Email Settings", "admin/admin-setting/email-out-settings","ap ap-email-settings");
	//$adminMenu->AddSubMenu("AD","Email To Ticket Settings", "admin/admin-setting/imap","ap ap-email-ticket");
...
if($apimenu){
    ...
    $apimenu->AddSubMenu("AD","Paypal Setting", "admin/api-setting/paypal-setting", "ap ap-paypal");
	if(count($api_list)>0){
